(function(){
  ...
  if(cart.length > 0) {
  	var cartAddBtns = document.getElementsByClassName('js-cd-add-to-cart'),
		...
		// cartImg = document.querySelectorAll('.workpls img')
		// personalbtn = document.querySelectorAll('.personalCart');
		...
		function addToCart(event) {
			// console.log(cartImg)
		    let cartImg = document.querySelectorAll('.workpls img')
			cartImg.addEventListener('click', ()=>{
				for (let i = 0; i < cartImg.length; i++) {	
			
				console.log(cartImg[i].src);
			}

			})
			
				// cartImg[i].addEventListener('click', ()=>{
				// 	// var imgSource = this.innerHTML
